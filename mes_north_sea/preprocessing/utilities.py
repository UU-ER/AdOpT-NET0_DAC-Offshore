...
class Configuration:
    def __init__(self):
        ...
        # Offshore data
        self.load_path_offshore_farms = self.raw_data_path_cap + 'WindFarms_v3.csv'

        # Biomass data
        self.load_path_biomass = self.raw_data_path_cap + 'Biomass_at_nodes.csv'

        # Hydro Inflows data
        self.load_path_hydro_inflow = 'C:/Users/6574114/OneDrive - Universiteit Utrecht/PhD Jan/Papers/DOSTA - HydrogenOffshore/00_raw_data/hydro_inflows/PEMMDB_'
